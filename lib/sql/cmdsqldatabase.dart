...
class CMDMySqlDatabase extends StatelessWidget {
  @override
...
void dbrun() async {
  ...
  print('Init...' + fido.toString());

  print('Insert a dog into the database');
  await insertDog(fido);

  print('Print the list of dogs (only Fido for now)');
  print(await dogs());

  print(' Update Fidos age and save it to the database');
  fido = Dog(
    id: fido.id,
    name: fido.name,
    age: fido.age + 7,
  ...
  print('Print Fidos updated information');
  print(await dogs());

  print('Delete Fido from the Database');
  await deleteDog(fido.id);

  print('Print the list of dogs (empty)');
  print(await dogs());
}
